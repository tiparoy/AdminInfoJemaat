   //yang penting jadi...😍:)
    ...
    const EMAILJEMAAT = EMAIL_JEMAAT.toLowerCase;
    function doGet(e) {
    ...
    function buletin(e){
      ...
      var gambar = e.parameter.GAMBAR;
        // ✅ CREATE NEW 
        if (e.parameter.func == "Baru" + passjemaat + EMAILJEMAAT) {
             var data = false
        ...
        // 📝 EDIT 
        if (e.parameter.func == "Edit" + passjemaat + EMAILJEMAAT) {
        ...
        // ❌ HAPUS 
        if (e.parameter.func == "Hapus" + passjemaat + EMAILJEMAAT) {
            var sh = ss.getSheetByName('Buletin');
            var kodenya = e.parameter.KODENYA;
            var kodeupdate = e.parameter.UPDATECODE;
    ...
    // ❤️❤️❤️❤️❤️❤️❤️❤️❤️  PROFIL JEMAAT  ❤️❤️❤️❤️❤️❤️❤️❤️❤️❤️
    function profiljemaat(e){
      var ss =  SpreadsheetApp.openById(GS_ID);
      var sh = ss.getSheetByName('update');
        // ☑️ SAVE PROFIL JEMAAT
        if (e.parameter.func == "UpdateFileHTML" + passjemaat + EMAILJEMAAT) {
            var kodeupdate = e.parameter.UPDATECODE;
